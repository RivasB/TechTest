package cloud.ttest.share.core.infrastructure.bus.query;

import cloud.ttest.share.core.domain.bus.query.IQuery;
import cloud.ttest.share.core.domain.bus.query.IQueryBus;
import cloud.ttest.share.core.domain.bus.query.IQueryHandler;
import cloud.ttest.share.core.domain.bus.query.IResponse;
import cloud.ttest.share.core.domain.bus.query.QueryHandlerExecutionError;
import cloud.ttest.share.core.domain.bus.query.QueryNotRegisteredError;
