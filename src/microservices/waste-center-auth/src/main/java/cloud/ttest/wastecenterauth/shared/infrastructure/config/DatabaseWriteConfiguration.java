...
import cloud.ttest.wastecenterauth.wastecenterauthorization.infrastructure.adapter.command.WasteCenterAuthorizationCommandRepositoryImpl;
...
@EnableJpaRepositories(entityManagerFactoryRef = "writeEntityManagerFactory", transactionManagerRef =
        "writeTransactionManager", basePackageClasses = {WasteCenterAuthorizationCommandRepositoryImpl.class})
